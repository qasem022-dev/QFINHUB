...
export async function generateMetadata({ params }: CalculatorPageProps) {
  ...
  const ctrTitles: Record<string, { title: string; ogTitle: string; metaDesc: string; ogDesc: string }> = {
    ...
    "compound-interest": {
      title: "Compound Interest Calculator — See How $100K Grows to $265K in 20 Years",
      ogTitle: "Compound Interest Calculator — See How $100K Grows to $265K",
    ...
    "mortgage-calculator": {
      title: "Mortgage Calculator — See Your Monthly Payment on Any Home ($200K, $500K, $900K)",
      ogTitle: "Mortgage Calculator — See Your Monthly Payment on Any Home",
    ...
    "loan-calculator": {
      title: "Loan Calculator — Calculate Any Monthly Payment: Personal, Auto, Student Loans",
      ogTitle: "Loan Calculator — Calculate Any Monthly Payment",
